...
const CompanyTabs = ({ company }) => {
  ...
  const notes = [
    {
      id: 1,
      content: `Initial contact made through LinkedIn. Company is looking for a comprehensive CRM solution to manage their growing sales team.\n\nKey requirements:\n- Multi-user access\n- Integration with existing tools\n- Mobile accessibility\n- Reporting capabilities`,
      timestamp: new Date(Date.now() - 5 * 24 * 60 * 60 * 1000),
      user: 'John Smith'
    },
    {
      id: 2,
      content: 'Follow-up call scheduled for next Tuesday at 2 PM EST. Company requested additional information about pricing tiers and implementation timeline.',
  ...
  const files = [
    {
      id: 1,
      name: 'Proposal_Company_2025.pdf',
      size: '2.4 MB',
      type: 'pdf',
  ...
  const renderTabContent = () => {
    switch (activeTab) {
      case 'activities':   // ✅ must match lowercase
        return (
